...
import { CreateHerramientaForm } from "../../components/forms/create-herramienta-form";
import { MobileAppShell } from "../../components/mobile-app-shell";

export default function CrearHerramientaPage() {
  return (
    <MobileAppShell>
      <div className="flex min-h-dvh flex-1 flex-col bg-neutral-100">
        ...
        <main className="flex flex-1 flex-col gap-4 px-4 py-6">
          <nav className="text-sm text-neutral-600">
            ...
            <span className="text-neutral-800">Herramienta</span>
          </nav>
