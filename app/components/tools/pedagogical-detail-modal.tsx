...
function lineasFuncionPedagogica(texto: string): string[] {
...
export function PedagogicalDetailModal({
  herramienta,
  closeHref,
}: {
  ...
  const lineasFunciones = lineasFuncionPedagogica(herramienta.funcionPedagogica);
  const usoDestacado =
  ...
  return (
    ...
    >
      ...
      >
        ...
        <header className="relative shrink-0 bg-gradient-to-r from-[#08527F] via-[#09A6D1] to-[#08527F] px-5 pb-5 pt-6 text-white">
          <button
            type="button"
            onClick={cerrar}
